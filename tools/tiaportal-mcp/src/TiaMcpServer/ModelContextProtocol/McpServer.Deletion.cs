...
namespace TiaMcpServer.ModelContextProtocol
{
    ...
    public static partial class McpServer
    {
        ...
        [McpServerTool(Name = "DeletePlcBlock"), Description(
            ...
            + "and back the block up with ExportBlock / ExportBlocks; compile with CompileSoftware after deletion and "
            + "before SaveProject. Regex and wildcards are rejected. To delete a tag table use DeletePlcTagTable, "
            + "a UDT use DeletePlcType.")]
            ...
            try
            {
                ...
                return BuildDeletionReport(
                    ...
                    nextActions: dryRun
                        ? new JsonArray
                        {
                            "ExportBlock / ExportBlocks —— 删之前先把这个块导出备份",
